...
## Проблема
Московскому зоопарку нужны опекуны для животных, но не хватает интерактивных способов привлечь внимание.

## Решение
Telegram-бот с викториной из 20 вопросов, который определяет тотемное животное пользователя и рассказывает о программе опеки.

## Результат
Увеличение интереса к программе опеки через развлечение и вовлечение пользователей.

## Технологии
- Python
- aiogram
- SQLite
- JSON (для начальных данных)
